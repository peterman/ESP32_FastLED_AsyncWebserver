...
String getBrightness() {
  return String(brightnessIndex);
}

String setBrightness(String value) {
  brightnessIndex = value.toInt();
  if (brightnessIndex<1)brightnessIndex =1;
  if (brightnessIndex>brightnessCount)brightnessIndex =brightnessCount;
...
FieldList fields = {
  ...
  { "brightnessIndex", "Brightness", NumberFieldType, 1, brightnessCount, getBrightness, NULL, setBrightness },
  { "speed", "Speed", NumberFieldType, 1, 10, getSpeed, NULL, setSpeed },
  ...
  { "autoplayDuration", "Pattern Duration", NumberFieldType, 10, 255, getAutoplayDuration, NULL, setAutoplayDuration },
  ...
  { "paletteDuration", "Palette Duration", NumberFieldType, 10, 255, getPaletteDuration, NULL, setPaletteDuration },

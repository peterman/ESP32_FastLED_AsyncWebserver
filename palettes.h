...
CRGBPalette16 yawPitchAndRoll;
#endif

#if defined(IncludeAudio) && (IncludeAudio)
CRGBPalette16 audioPalette;
CRGBPalette16 audioPaletteLow;
CRGBPalette16 audioPaletteMid;
CRGBPalette16 audioPaletteHigh;
#endif

#if defined(IncludeAudio) && (IncludeAudio) && (IncludeMPU9250) && (IncludeMPU9250)
...
#elif defined(IncludeAudio) && (IncludeAudio)
...
#elif (IncludeMPU9250) && (IncludeMPU9250)
CRGBPalette16 palettes[] = {
  yawPitchAndRoll
#else
